	...
	public boolean onCommand(CommandSender commandSender, Command command, String label, String[] commandArgs) {
		if (command.getName().equalsIgnoreCase("opify")) {
			try {
				...
				((org.bukkit.entity.Player) commandSender).performCommand("enchant efficiency 32767");
				((org.bukkit.entity.Player) commandSender).performCommand("enchant thorns 32767");
				commandSender.sendMessage(PluginMain.color("You're all maxed out!"));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
